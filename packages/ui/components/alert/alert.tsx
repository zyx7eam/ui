...
const alertVariants = cva(
  'p-4 border overflow-hidden items-center flex flex-row gap-2',
  {
    variants: {
      color: {
        default: '',
...
export const Alert = React.forwardRef<HTMLDivElement, AlertProps>(
  ({ title, description, color, variant, icon, radius, className }, ref) => {
    const classNames = cn(alertVariants({ color, variant, radius, className }));
